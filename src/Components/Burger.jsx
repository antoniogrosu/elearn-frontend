    ...
    <>
      {!isOpen ? (
        ...
        <div className="w-full">
          <div className="z-10 bg-gray-800 p-2 absolute w-8/12 right-0 top-0 rounded-l-2xl h-full flex flex-col items-center pt-6">
            ...
            <Link to="/courses">
              <p className="text-sm open-sans text-gray-50 w-full text-left py-2">
                Courses
              </p>
            </Link>
          </div>
          <div
            className="bg-gray-900 opacity-75 p-2 absolute w-full z-0 left-0 top-0 rounded-l-2xl h-full"
