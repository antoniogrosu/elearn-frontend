...
export default function Suggestion() {
  return (
    <div className="w-full md:w-10/12 bg-gradient-to-r from-purple-800 to-fuchsia-400 p-6 md:p-8 rounded-2xl flex md:flex-row flex-col items-start justify-around ">
      <div className="w-full md:w-4/12">
        ...
        <p className="text-gray-50 open-sans text-sm mt-4">
          Because You Enjoyed Python Basics, We would like to recommend you :{" "}
        </p>
      </div>
        ...
        <div className="bg-gray-800 p-6 w-full md:w-10/12 border-y-4 border-teal-100 rounded-md">
          ...
          <div className="mt-4 flex items-center justify-start w-full">
            ...
            <p className="text-xs text-gray-50 open-sans ml-4">
              by <span className="font-semibold">Mangus Thunderbolt</span>
            </p>
          </div>
