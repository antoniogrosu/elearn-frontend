...
export default function Suggestion() {
  ...
  return (
    <div className="w-full md:w-10/12 2xl:w-4/12 bg-gradient-to-r from-purple-800 to-fuchsia-400 p-6 md:p-8 rounded-2xl flex md:flex-row flex-col items-start justify-around ">
